...
It can be seen that in some cases the algorithm finds the "correct" nonlinaer interpretation of the data, but sometimes it converges into a bad local optimum.
